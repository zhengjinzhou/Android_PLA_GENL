...
public class DaKaPresenter extends RxPresenter<DkContract.View> implements DkContract.Presenter<DkContract.View>{

    VpnApi vpnApi;
    DaKaFragment dkFragment;

    public DaKaPresenter(DaKaFragment dkFragment){
